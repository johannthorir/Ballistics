function StandardModel(maxRange) {
    
    var __BCOMP_MAXRANGE__ = maxRange;
    ...
    function FindZero(DragFunction, DragCoefficient, Weight, Vi, SightHeight, ShootingAngle, ZAngle, WindSpeed, WindAngle ) {
        var dt = 0.25/Vi;
